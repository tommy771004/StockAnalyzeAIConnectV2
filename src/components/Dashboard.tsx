...
const TradeRow: React.FC<{ date: string; ticker: string; action: string; entry?: number; exit?: number; pnl: number; status: 'Win' | 'Loss' }> = ({ date, ticker, action, entry, exit, pnl, status }) => {
  return (
